...
class InboundShipments(MWS):
    ...
    def create_inbound_shipment_plan(self, ship_from_address, ship_to_country_code=None, ship_to_country_subvision_code=None, label_prep_preference=None, inbound_shipment_plan_request_items):
